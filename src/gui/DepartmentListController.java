...
public class DepartmentListController<Integer> implements Initializable, DataChangeListener {
	...
	private void removeEntity(Department obj) {
		Optional<ButtonType> result = Alerts.showConfirmation("Confirmation", "Tem certeza de que você quer deletar?");
